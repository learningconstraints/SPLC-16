...
(
		...
		{ 
	        newCompositeNode(grammarAccess.getFeatureDescriptionAccess().getRefFeatFeatureCrossReference_1_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
		...
		{ 
	        newCompositeNode(grammarAccess.getAttributeDescriptionAccess().getRefFeatFeatureCrossReference_1_1_0_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
